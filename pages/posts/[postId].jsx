...
const PostsDetail = () => {
  ...
  return (
    ...
    <div className="xl:ml-[300px] border-l border-r border-gray-200 xl:min-w-[700px] sm:ml-[73px] flex-grow max-w-xl">
      ...
      <div className=''>
        <Link href={'/'} className='flex items-center gap-1 border-b py-4 px-3'>
        ...
        <div>
          ...
          <div className='flex justify-between items-center w-3/10'>
              <label className='cursor-pointer inline-flex gap-1 items-center text-gray-400 hover:text-blue-500 rounded-lg hover:bg-blue-100 py-1 px-2'>
                ...
                <span className="text-[14px] ">{tweetInfo?.numOfComments}</span>
              </label>
              <label className='cursor-pointer inline-flex gap-1 items-center text-gray-400 hover:text-red-400 rounded-lg hover:bg-red-100 py-1 px-2'>
                ...
                <span className='text-[14px] '>{tweetInfo?.numOfLikes}</span>
              </label>
          </div>
        </div>
      </div>
      ...
      <div className='pt-4 pb-2 px-3 border-b '>
        <div className='flex gap-4'>
          ...
          <div className='pr-4 w-full'>
            <textarea className='w-full min-h-[100px] my-1 py-2 px-3 rounded-sm focus:border-0' placeholder='Tweet your reply..'/>
          </div>
        </div>
        <div className='text-end pr-4'>
          <button className='bg-primary-blue text-white py-2 px-4 rounded-3xl'>Reply</button>
        </div>
      </div>
