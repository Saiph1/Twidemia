    ...
    <div className="flex min-h-screen max-w-7xl w-full mx-auto">
        ...
        <div className="xl:ml-[300px] border-l border-r border-gray-200 xl:min-w-[700px] sm:ml-[73px] flex-grow max-w-xl">
            ...
            <div className='bg-gray-100 flex gap-3 py-3 px-5 border-b'>
                <p className='font-[400] py-1 px-3 rounded-full bg-[#252525] text-white border'>Difficulty</p>
                <p className='font-[400] py-1 px-3 rounded-full bg-white border'>Grading</p>
                <p className='font-[400] py-1 px-3 rounded-full bg-white border'>Rewarding</p>
                <p className='font-[400] py-1 px-3 rounded-full bg-white border'>Sources</p>
        ...
        <div className='my-8 flex flex-col items-center gap-4'>
          ...
          <div className="shadow-tweetPosts bg-white flex rounded-2xl w-9/10 gap-4 py-3 px-6 min-h-[8rem]">
            <div className='max-w-[3rem]'>
              <img src={'https://www.cse.cuhk.edu.hk/wp-content/uploads/people_large/Irwin-King.jpg'} alt="icon" className='rounded-full w-full object-cover aspect-square'/>
            </div>
            ...
            <div className='w-full'>
              ...
              <div className='mb-2'>
                <p className='text-[16px] text-gray-600'>My CSCI2100A class will make you cry, try me! and come try yourself</p>
              </div>
              ...
              <div className='w-4/10 flex justify-between ml-[-0.5rem]'>
                ...
                <label className='cursor-pointer inline-flex gap-1 items-center text-gray-400 hover:text-red-400 rounded-lg hover:bg-red-100 py-1 px-2'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="#FE8E86" viewBox="0 0 24 24" stroke-width="0" stroke="currentColor" class="w-5 h-5 ">
          ...
          <div className="shadow-tweetPosts bg-white flex rounded-2xl w-9/10 gap-4 py-3 px-6 min-h-[8rem]">
            <div className='max-w-[3rem]'>
              <img src={'https://www.cse.cuhk.edu.hk/wp-content/uploads/people_large/CHAN-Siu-On.jpg'} alt="icon" className='rounded-full w-full object-cover aspect-square'/>
            </div>
            ...
            <div className='w-full'>
              ...
              {/* This part is tweet content */}
              <div className='mb-2'>
                <p className='text-[16px] text-gray-600'>CSCI3130 is just drawing some simple circle and that is it</p>
              </div>
          ...
          <div className="shadow-tweetPosts bg-white flex rounded-2xl w-9/10 gap-4 py-3 px-6 min-h-[8rem]">
            <div className='max-w-[3rem]'>
              <img src={'https://croucher.org.hk/wp-content/uploads/2011/07/Lyu-R-Michael-e1310028295489.jpg'} alt="icon" className='rounded-full w-full object-cover aspect-square'/>
            </div>
            ...
            <div className='w-full'>
              ...
              {/* This part is tweet content */}
              <div className='mb-2'>
                <p className='text-[16px] text-gray-600'>CSCI3100 course only have 3 assignments, very EASY right?</p>
              </div>
          ...
          <div className="shadow-tweetPosts bg-white flex rounded-2xl w-9/10 gap-4 py-3 px-6 min-h-[8rem]    justify-center">
            <div className='max-w-[3rem]'>
              <img src={'https://www.cse.cuhk.edu.hk/wp-content/uploads/people/TAO-Yufei.jpg'} alt="icon" className='rounded-full w-full object-cover aspect-square'/>
            </div>
            ...
            <div className='w-full'>
              ...
              {/* This part is tweet content */}
              <div className='mb-2'>
                <p className='text-[16px] text-gray-600'>Wanna have a faster algorithm? take my CSCI3160 course! It is SIMPLE and sweet</p>
              </div>
