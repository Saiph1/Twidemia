    ...
    <div className="flex gap-4">
      ...
      <div className="pr-4 w-full relative">
        ...
        <div className="px-2 reletive grid gap-3">
          ...
          <ul className="list">
            <li onClick={() => setPrivacySetting("Public")} className="flex gap-3 items-center p-2 cursor-pointer hover:bg-gray-200 font-semibold"> 
              {privacyOptionUI("Public")}
            </li>
            <li onClick={() => setPrivacySetting("Follower")} className="flex gap-3 items-center p-2 cursor-pointer hover:bg-gray-200 font-semibold">
              {privacyOptionUI("Follower")}
            </li>
            <li onClick={() => setPrivacySetting("Self")} className="flex gap-3 items-center p-2 cursor-pointer hover:bg-gray-200 font-semibold">
