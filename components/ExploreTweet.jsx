  ...
  return (
    <div className="shadow-tweetPosts bg-white flex rounded-2xl w-9/10 gap-4 py-3 px-6 min-h-[8rem]">
        <div className='max-w-[3rem]'>
            <img src={'https://www.cse.cuhk.edu.hk/wp-content/uploads/people_large/FUNG-Ping-Fu.jpg'} alt="icon" className='rounded-full w-full object-cover aspect-square'/>
        </div>
        ...
        <div className='w-full'>
            ...
            <div className='mb-2'>
                <p className='text-[16px] text-gray-600'>CSCI1130 is the most easiest CSCI coures!!! everyone gets A grade in my course :D</p>
            </div>
