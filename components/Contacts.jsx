          ...
          <div className="contacts h-full overflow-y-auto flex flex-col">
            {contacts.map((contact, index) => {
              return contacts[index].userId!=viewerid?(
                <div className={`flex items-center px-4 py-2 ${contact.username === currentChat.username? 'bg-gray-300 scale-120 border-l-[4px] border-primary-blue' : 'hover:bg-gray-200 '}`} onClick={() => changeCurrentChat(index, contact)}>
